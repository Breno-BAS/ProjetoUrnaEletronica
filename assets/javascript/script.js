    ...
    if(candidato.length > 0) {
        ...
        for(let i in candidato.fotos) {
            if(candidato.fotos[i].small) {
                fotosHtml += `<div class="d-1-imagem small"><img src="assets/images/${candidato.fotos[i].url}" alt="">${candidato.fotos[i].legenda}</div>`
            } else {
                fotosHtml += `<div class="d-1-imagem"><img src="assets/images/${candidato.fotos[i].url}" alt="">${candidato.fotos[i].legenda}</div>`
            }
